...
# new plot
plot(df2$date2,(as.numeric(df2$Voltage)/8), pch="", ylab="Voltage", xlab="datetime")
lines(df2$date2, (as.numeric(df2$Voltage)/8))
...
# new plot
plot(df2$date2,as.numeric(df2$Global_reactive_power)/400, pch="", ylab="Global_reactive_power", xlab="datetime")
lines(df2$date2, as.numeric(df2$Global_reactive_power)/400)
dev.off()